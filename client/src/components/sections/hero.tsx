      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="block text-powerfix-yellow">
              Adhesive Solutions
            </span>
          </h1>
          <p className="text-xl text-white mb-8 max-w-3xl mx-auto">
            Manufactured in Rwanda using advanced Turkish technology, Powerfix
            delivers premium adhesive solutions for construction professionals.
            Easy to apply, strong bonding, and highly resistant to water and
            humidity.
          </p>
