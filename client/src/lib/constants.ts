...
export const REFERENCE_PROJECTS = [
  ...
  },
  {
    ...
    image: "images/intare.jpg"
  },
  {
    id: "greenland",
    name: "Greenland Plaza",
    description: "Modern infrastructure project using Powerfix adhesive solutions",
