      ...
      <section className="bg-powerfix-dark text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Comprehensive range of construction adhesives for every application, manufactured with Turkish technology
          </p>
        </div>
      </section>
                ...
                <Card key={product.id} className="bg-white shadow-lg">
                  <CardContent className="p-8">
                    <div className="flex items-center mb-6">
                      <div className={`w-16 h-16 ${colors[index].bg} rounded-lg flex items-center justify-center mr-4`}>
                        <Icon className={`w-8 h-8 ${colors[index].text}`} />
                      </div>
                      <div>
                        <h3 className="text-2xl font-semibold text-powerfix-dark">{product.name}</h3>
                        <Badge variant="secondary" className="mt-1">High Performance</Badge>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-6">
                      {product.features.map((feature, featureIndex) => (
                        <div key={featureIndex} className="flex items-center">
                          ...
                          <span className="text-powerfix-gray">{feature}</span>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t">
                      <div>
                        <span className="text-powerfix-red font-semibold text-lg">{product.package} Package</span>
                      </div>
                      <div>
                        <span className="text-powerfix-dark font-medium">Made in Rwanda</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-powerfix-dark mb-4">Why PowerFix Products</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center p-6 bg-gray-50 rounded-xl">
                ...
                <h3 className="text-xl font-semibold text-powerfix-dark mb-3">{feature.title}</h3>
